...
const I18N = {
  en: {
    ...
    userNameGuide: "Tell Comnyang your name, and Comnyang will call you for reminders and other moments.",
  ...
  ja: {
    ...
    userNameGuide: "名前を教えると、Comnyang が通知やいろいろな場面であなたを呼んでくれます。",
